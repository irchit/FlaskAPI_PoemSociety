...
# 🔧 Conectare MongoDB
client = MongoClient("mongodb+srv://rchitea:rcDWkAxnUfGyzSV4@clusterpoemsociety.pui6xab.mongodb.net/?retryWrites=true&w=majority&appName=ClusterPoemSociety")
...
def register():
    ...
    max_id = users_col.find_one({}, sort=[("_id", DESCENDING)])
    if max_id:
        max_id = max_id["_id"]
    else:
        max_id = 1
